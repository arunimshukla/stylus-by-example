...
# Use the bytecode pinned by the official Nitro dev node.
deployer_code=$(curl -fsSL \
  https://raw.githubusercontent.com/OffchainLabs/nitro-devnode/ebb523d4ed9c04d4183743af844a038e9843f352/stylus-deployer-bytecode.txt)
